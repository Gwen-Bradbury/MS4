...
> Cornflakes ('checkout.signals' imported but unused); This allows the Admin to see the order total, grand total and delivery cost in Admin Page, and for the customer to see the same totals in thier confirmation emails.
